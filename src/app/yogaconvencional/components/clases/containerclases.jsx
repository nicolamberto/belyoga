    ...
    return (
        <div className='flex justify-center items-center w-[100%]'>
            ...
            <div className='flex flex-col justify-center items-center w-[34%] sm:w-[35%] md:w-[40%] lg:w-[60%]'>
                <p className='text-[25px] xl:text-[35px] text-[#033908] font-bold pb-6'>
                    {name}
                </p>

                <div className=" flex flex-col gap-6 text-[#033908] text-opacity-80 text-justify font-[1px] text-[11px] lg:text-[13px] xl:text-[15px]">
                    <p>{text1}</p>
                    <p>{text2}</p>
                    <p>{text3}</p>
                    <p>{text4}</p>
                ...
                <div className='flex flex-row justify-between items-center pt-5 md:pt-10 lg:pt-20 pb-5 w-[100%] sm:w-[80%] text-[#033908] text-opacity-80 text-justify font-[1px] text-[11px] lg:text-[13px] xl:text-[15px]'>
                ...
                <div className="flex justify-center items-center flex-row font-[1px] text-[11px] lg:text-[13px] xl:text-[15px]">
