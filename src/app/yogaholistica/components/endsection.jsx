...
export default function EndSection() {
  return (
    <div className='w-[80%] xl:w-[50%] flex flex-col justify-center items-center gap-20 lg:gap-32'>
      {endSectionHolistica.map((item, index) => (

        <ul key={index} className=' w-full text-[#033908] text-opacity-80 text-justify font-[1px] text-[11px] lg:text-[13px] xl:text-[15px] flex flex-col gap-10 '>
